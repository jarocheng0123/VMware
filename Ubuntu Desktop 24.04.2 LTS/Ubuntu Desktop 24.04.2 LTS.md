...
tar -xzf /media/ur/VMware\ Tools/VMwareTools-*.tar.gz -C /tmp/vmware-tools && \
...
#### 安装firefox浏览器扩展
- [GNOME Shell integration](https://addons.mozilla.org/zh-CN/firefox/addon/gnome-shell-integration/?utm_source=addons.mozilla.org&utm_medium=referral&utm_content=search)
